...
Now create a folder called `game` inside of the `lovepotion` directory. Inside of this will be your source files for what LÖVE Potion will be running. Inside of `game` should be a file named `main.lua`. The content of this file is the main entry point.
